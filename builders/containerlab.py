    ...
    def build_sibling(self, config: dict, real_topo: dict, sibling: str, sibling_topo: dict, sibling_nodes: dict, queues: dict):
        ...
        if sibling_config:
            if sibling_config.get('autostart'):
                running = self.start_sibling(config, real_topo, sibling, sibling_topo, queues)
        return running


    def start_sibling(self, config: dict, real_topo: dict, sibling: str, sibling_topo: dict, queues: dict):
